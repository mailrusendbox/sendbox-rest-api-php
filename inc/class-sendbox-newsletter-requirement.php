...
/**
 *
 * Class Sendbox_Newsletter_Requirement
 */
class Sendbox_Newsletter_Requirement {
	...
	/**
	 * Sendbox_Newsletter_Requirement constructor.
	 */
	...
	public function admin_notices() {
		...
		if ( in_array( 'php', $this->error_msg ) ) {
			$message = sprintf( '<p><strong>%s</strong></p><p>%s</p>', __( "We've noticed that you're running an outdated version of PHP and plugin \"Sendbox Email Marketing Newsletter\" can't run.", 'sendbox-email-marketing-newsletter' ), __( "Ask you hosting <a href=\"https://wordpress.org/about/requirements/\">update PHP</a>.", 'sendbox-email-marketing-newsletter' ) );
		}
