 ...
 *
 * Class Sendbox_Newsletter_Users
 */
class Sendbox_Newsletter_Users {

	/**
	 * Sendbox_Newsletter_Users constructor.
	 */
	public function __construct() {

		$is_subscribe_after_register = Sendbox_Newsletter_Settings::get_option( 'is_subscribe_after_register', 'sp_api_setting' );
	...
	public function subscribe_after_register( $user_id ) {
		...
		if ( isset( $result->is_error ) && $result->is_error ) {
			$msg = isset( $result->message ) ? $result->message : __( 'Something went wrong', 'sendbox-email-marketing-newsletter' );

			error_log( 'Sendbox Newsletter: ' . $msg );
		}
	}
